...
exports.UserUserGroupMap = void 0;
const typeorm_1 = require("typeorm");
const User_1 = require("./User");
const UserGroup_1 = require("./UserGroup");
let UserUserGroupMap = (() => {
    ...
    var UserUserGroupMap = _classThis = class {
        constructor() {
            this.userId = __runInitializers(this, _userId_initializers, void 0);
            this.userGroupId = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _userGroupId_initializers, void 0));
            this.user = (__runInitializers(this, _userGroupId_extraInitializers), __runInitializers(this, _user_initializers, void 0));
            this.userGroup = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _userGroup_initializers, void 0));
            __runInitializers(this, _userGroup_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "UserUserGroupMap");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _userId_decorators = [(0, typeorm_1.PrimaryColumn)()];
        _userGroupId_decorators = [(0, typeorm_1.PrimaryColumn)()];
        _user_decorators = [(0, typeorm_1.ManyToOne)(() => User_1.User, user => user.id)];
        ...
        UserUserGroupMap = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserUserGroupMap = _classThis;
})();
exports.UserUserGroupMap = UserUserGroupMap;
